...
function layout({children}) {
  ...
  useEffect(()=> {
    if(pathname.includes('main') && (localStorage.currentUser === undefined || localStorage.currentUser === null || token == null || token === undefined)) {
  ...
  return (
    <>
        {!(pathname.includes('main') && (localStorage.currentUser === undefined || localStorage.currentUser === null || token == null || token === undefined)) &&<>
            <Nav />
